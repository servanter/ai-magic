...
- **Door-to-balloon time**: 60 minutes (NHS target: <90 minutes for STEMI)  
...
4. If confidence <90% or high-risk → Doctor reviews immediately
...
- ❌ **Low confidence** (<80% accuracy): Mental health (nuanced, subjective), predicting exact outcomes (too many variables)
